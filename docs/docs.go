...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/customer": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Search by customer_name/customer_code",
                        "name": "search",
                        "in": "query"
                    },
                    {
        ...
        "/finance/payments": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "filter project_code",
                        "name": "project_code",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "search doc_no",
                        "name": "search",
                        "in": "query"
                    },
                    {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.RecordPaymentRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/finance/payments/{doc_type}/{doc_id}/log": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/grn/{id}/confirm": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Optional delivery_date",
                        "name": "body",
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/models.ConfirmGRNRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/ic/projects/by-code/{projectCode}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/ic/projects/{projectCode}/cost-codes": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "target project.project_code (ToProject)",
                        "name": "projectCode",
                        "in": "path",
                        "required": true
                    }
        ...
        "/ic/projects/{projectCode}/cost-transactions": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter: PO, MOVEMENT_ISSUE, or MOVEMENT_TRANSFER",
                        "name": "ref_type",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Search mat_code/mat_name",
                        "name": "search",
                        "in": "query"
                    },
                    {
        ...
        "/ic/projects/{projectCode}/job-codes": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/ic/projects/{projectCode}/movements": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Movement header",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.CreateIcProjectMovementRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/ic/projects/{projectCode}/movements/{id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "ic_project_movement.id",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
        ...
        "/ic/projects/{projectCode}/movements/{id}/available-materials": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "movement's own project.project_code",
                        "name": "projectCode",
                        "in": "path",
                        "required": true
                    },
                    {
                        "type": "integer",
                        "description": "ic_project_movement.id (unused for filtering here, kept for route symmetry)",
                        "name": "id",
                        "in": "path",
                        "required": true
                    },
                    {
                        "type": "string",
                        "description": "optional job_code filter (e.g. MP)",
                        "name": "job_code",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "cost_subgroup.id filter",
                        "name": "subgroup_id",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "mat_name.id filter",
                        "name": "mat_name_id",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "search mat_code / mat_name / spec",
                        "name": "q",
                        "in": "query"
                    }
                ],
        ...
        "/ic/projects/{projectCode}/movements/{id}/lines": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.CreateIcProjectMovementLineRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/ic/projects/{projectCode}/movements/{id}/submit": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/ic/projects/{projectCode}/stock": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by job code (e.g. MP)",
                        "name": "job_code",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Match mat_code or mat_name",
                        "name": "search",
                        "in": "query"
                    },
                    {
                        "type": "boolean",
                        "description": "Only rows with qty_on_hand \u003e 0 (default true)",
        ...
        "/master/allMaterial": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "When set, adds stock_on_hand per material from project_stock for that project (read-only reference, e.g. Petty Cash line picker)",
                        "name": "project_code",
                        "in": "query"
                    },
                    {
        ...
        "/master/mat-names/{id}": {
            "put": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Mat_name ID",
                        "name": "id",
                        "in": "path",
                        "required": true
                    },
                    {
                        "description": "New mat_name",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/master/materials/{code}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.MaterialDetailFull"
                        }
                    },
                    "404": {
                        "description": "Not Found",
            ...
            "put": {
                ...
                "description": "Partial update — only fields present in the body are changed. Reassigns which\nexisting group/subgroup/mat_name/spec/brand/unit row this material points to\n(by id); it does not rename shared master rows, and mat_code is never accepted\nfrom the client. If any of group_id/subgroup_id/mat_name_id/spec_id/brand_id/\nunit_id changes, mat_code is auto-regenerated server-side as\ngroup_code+subgroup_code+mat_name_code+spec_code+brand_code+unit_code (the\nconfirmed composition rule), and the change is cascaded in the same\ntransaction to every table that references mat_code — including stock_item,\nwhich has no FK and would otherwise silently lose its link to this material.\nIf the regenerated code would collide with a different existing material, the\nupdate is rejected with 409.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.UpdateMaterialFullRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/master/projects/import/template": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/master/subgroups/{id}": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "New subgroup_name (required) and optional group_id",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/petty-cash": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "filter: document has at least one line with this project",
                        "name": "project_code",
                        "in": "query"
                    },
                    {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Petty cash requisition data",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.CreatePettyCashRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/petty-cash/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Petty cash requisition ID",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.UpdatePettyCashRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/petty-cash/{id}/submit": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "approver_id — required if not already set",
                        "name": "body",
                        "in": "body",
                        "schema": {
                            "type": "object",
        ...
        "/po/line-items": {
            "get": {
                ...
                "description": "Cross-PO report — every PO with status=APPROVED (approval status only; status_receive is\nnot considered), one object per PO with a nested \"lines\" array. mat_code filter is applied\nat the line level: only lines matching the filter appear in \"lines\", and a PO is dropped\nfrom the result entirely if none of its lines match. Pagination (page/page_size)\npaginates POs, not lines.",
                "produces": [
                    "application/json"
                ],
                "tags": [
        ...
        "/pr": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "status filter — one of DRAFT, COMPLETED, STOCK_CHECK, PARTIALLY_FILLED, FULFILLED, CANCELLED",
                        "name": "status",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "matches pr_no or remarks (ILIKE, substring)",
                        "name": "search",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "filter by created_at \u003e= this date (YYYY-MM-DD)",
                        "name": "date_from",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "exact match on pr.job_code",
                        "name": "job_code",
                        "in": "query"
                    },
                    {
        ...
        "/work-order": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Search by wo_no/supplier_name/employer_name",
                        "name": "search",
                        "in": "query"
                    },
                    {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.CreateWorkOrderRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/work-order/{id}": {
            ...
            "put": {
                ...
                "description": "Accepts the same body shape as Create (models.CreateWorkOrderRequest) — lines are\nalways replaced together with the header in this single call, mirroring\nPOHandler.Update's all-in-one PUT rather than requiring a separate lines call.\nThe dedicated PUT /work-order/{id}/lines endpoint remains available for a\nlines-only edit that doesn't touch header fields. Only allowed while\nstatus = DRAFT — mirrors PO's Update rule exactly (PO also rejects everything\nelse, including REJECTED, and points APPROVED callers at its edit-approved\nendpoint instead; WO has no such endpoint yet, so APPROVED/other statuses just 400).\nThe payload's own ` + "`" + `status` + "`" + ` field (\"บันทึกร่าง\" sends DRAFT, \"ส่งอนุมัติ\" sends\nPENDING_APPROVAL) is written to the row and, when it actually changes, logged to\nwork_order_status_log — a transition to PENDING_APPROVAL also opens the step-1\napproval_request exactly like POST /:id/submit does, since this is an alternate\nentry point into the same submit flow. Any other status value is rejected —\napproval decisions only ever happen through the dedicated Approve/Reject flow.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.UpdateWorkOrderLinesRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/work-order/{id}/submit": {
            "post": {
                ...
                "description": "Opens the step-1 approval_request if doc_type='WO' step 1 is configured in\napproval_config; otherwise the status change happens with no approval request\n(mirrors MemoHandler.Submit's hasConfig guard). Actual approve/reject happens via\nPUT /approval/WO/{id}/approve|reject (GenericApprovalHandler), not here.",
                "produces": [
                    "application/json"
                ],
                "tags": [
    ...
    "definitions": {
        ...
        "models.CreateIcProjectMovementLineRequest": {
            "type": "object",
            "required": [
                "cost_subgroup_id",
                "mat_code",
            ...
            "properties": {
                ...
                "to_cost_subgroup_id": {
                    "description": "required for TRANSFER, ignored for ISSUE",
                    "type": "integer"
                },
                "to_project_code": {
                    "description": "required for TRANSFER, ignored for ISSUE",
        ...
        "models.CreateIcProjectMovementRequest": {
            "type": "object",
            "required": [
                "doc_type",
                "job_code",
        ...
        "models.CreatePettyCashLineItem": {
            "type": "object",
            "required": [
                "mat_code",
                "project_code",
        ...
        "models.CreatePettyCashRequest": {
            ...
            "properties": {
                ...
                "lines": {
                    ...
                    "minItems": 1,
                    "items": {
                        "$ref": "#/definitions/models.CreatePettyCashLineItem"
                    }
                },
                "purpose": {
                    "type": "string"
        ...
        "models.CreateProjectReq": {
            ...
            "properties": {
                ...
                "customer_id": {
                    "description": "FK -\u003e customer.cus_id — new dropdown-selected \"เจ้าของโครงการ\"",
                    "type": "integer"
                },
                "dept_code": {
                ...
                "job_codes": {
                    "description": "subset of MP/ME/MS/MF/MG/MH/G — validated server-side",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
                ...
                "location_code": {
                    "description": "free-text project address",
                    "type": "string"
                },
                "owner_id": {
        ...
        "models.CreateWorkOrderRequest": {
            ...
            "properties": {
                ...
                "lines": {
                    ...
                    "minItems": 1,
                    "items": {
                        "$ref": "#/definitions/models.WorkOrderLineInput"
                    }
                },
                ...
                "use_discount": {
                    "description": "Line items + header discount/VAT/WHT flags — mirrors PO's use_discount/discount_type/\nuse_vat/use_wht + purchase_order_line structure, with cost_code replacing mat_code.",
                    "type": "boolean"
                },
                "use_vat": {
                    "type": "boolean"
        ...
        "models.EditApprovedPORequest": {
            ...
            "properties": {
                ...
                "lines": {
                    ...
                    "minItems": 1,
                    "items": {
                        "$ref": "#/definitions/models.EditApprovedPOLine"
                    }
                },
                "location_text": {
                    "type": "string"
        ...
        "models.ProjectFull": {
            ...
            "properties": {
                ...
                "customer_id": {
                    "description": "FK -\u003e customer.cus_id — new dropdown-selected \"เจ้าของโครงการ\" going forward",
                    "type": "integer"
                },
                "customer_name": {
                    "description": "joined from customer.customer_name via customer_id",
                    "type": "string"
                },
                "dept_code": {
                    "description": "\"แผนก\" — FK -\u003e departments.dept_code",
                ...
                "location_code": {
                    "description": "free-text project address — no longer an FK/lookup against location.location_code",
                    "type": "string"
                },
                "owner_id": {
                ...
                "project_owner_name": {
                    "description": "free text (\"เจ้าของโครงการ\") — legacy, kept for backward compat with existing records",
                    "type": "string"
                },
                "remaining_amount": {
                    "type": "number"
        ...
        "models.UpdateMaterialFullRequest": {
            "type": "object",
            "properties": {
                "brand_id": {
                    "type": "integer"
        ...
        "models.UpdateProjectReq": {
            ...
            "properties": {
                ...
                "is_active": {
                    "description": "IsActive: nil (omitted) means \"leave unchanged\" — Update reads the project's current\nvalue and preserves it rather than defaulting to false. See project_handler.go Update.",
                    "type": "boolean"
                },
                "job_codes": {
                    "description": "subset of MP/ME/MS/MF/MG/MH/G — validated server-side",
        ...
        "models.UpdateWorkOrderLinesRequest": {
            "type": "object",
            "required": [
                "lines"
            ],
